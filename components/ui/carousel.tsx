...
>(
  (
    ...
    const wheelGestures = WheelGesturesPlugin({
      ...
      wheelDirection: orientation === "horizontal" ? "horizontal" : "vertical",
      wheelEffect: 'fluid', // Use fluid for smooth inertia-based scrolling
      dragFree: true, // Enable momentum-based scrolling for wheel gestures
      wheelMultiplier: 1.2, // Reduced for less aggressive wheel capture
      // Improved options for mobile
      smoothing: true,
      smoothingDuration: 200,
      smoothingFunction: t => 1 - Math.pow(1 - t, 2),
    })
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className="overflow-visible embla">
      <div
        ref={ref}
        className={cn(
