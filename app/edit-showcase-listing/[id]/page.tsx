...
export default function EditShowcaseListingPage() {
  ...
  const fetchListing = async () => {
    try {
      ...
      if (error) {
        ...
        toast.error('Failed to fetch showcase listing');
    ...
    <div className="min-h-screen bg-[#E1E8E0]">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-berkshire text-brand-dark-green mb-2">Edit Showcase Listing</h1>
