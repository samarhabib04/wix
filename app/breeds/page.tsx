...
const Breeds = () => {
  const [filters, setFilters] = useState({
    ...
    energy: [],
    search: "",
    county: [] // Added the missing county property
  });
  ...
  const activeFilterCount = (
    ...
    (filters.county.length > 0 ? 1 : 0) + // Added county to the filter count
    (filters.search ? 1 : 0)
  );
    ...
    <div className="bg-[#E1E8E0] w-full">
      <div className="container mx-auto px-4 py-6 md:py-8 lg:py-10 min-h-screen">
        <div className="bg-brand-soft-green rounded-lg p-6 md:p-8 mb-8">
          <h1 className="font-berkshire text-3xl md:text-4xl lg:text-5xl text-white mb-3">Browse Pedigree Breeds</h1>
          <p className="text-white text-lg md:text-xl opacity-90">Explore purebred puppies and dogs by breed, size, and temperament.</p>
        </div>
        ...
        <BreedGrid filters={filters} breedType="Pedigree" />
      </div>
