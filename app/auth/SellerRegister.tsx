...
import { Mail, Lock, Loader2, User, Phone, MapPin, FileText, CheckCircle2, XCircle, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export default function SellerRegister() {
  ...
  const onSubmit = async (data: SellerFormData) => {
    ...
    try {
      ...
      localStorage.setItem('preselectedRole', 'seller');
  ...
  return (
    <AuthLayout
      ...
      description="Join Dog Quest as a trusted breeder"
    >
      <div className="space-y-6">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <p className="text-xs text-gray-600">
              You can add these verification IDs later in your dashboard settings
            </p>
                ...
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="text-sm">
                      Subscribe to our newsletter for breeding tips and marketplace updates
                    </FormLabel>
                  </div>
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="text-sm">
                      I agree to the{" "}
                      <Link href={termsHref} className="text-brand-dark-green hover:underline">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link href={privacyHref} className="text-brand-dark-green hover:underline">
                        Privacy Policy
                      </Link>
                    </FormLabel>
                  </div>
        ...
        <p className="text-sm text-center text-gray-600">
          ...
          <Link href={loginHref} className="text-brand-dark-green hover:underline">
            Sign in
          </Link>
        </p>
      </div>
